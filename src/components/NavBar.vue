  ...
  <header>
    <div class="navBar">
      <nav class="navCss">
        ...
        <RouterLink class="routerLink" to="/FoodBook">Posts</RouterLink>

        <RouterLink v-if="isUserConnected" class="routerLink" to="/ProfileEdit"
        ...
        >
        <RouterLink v-else class="routerLink" to="/inscription"
          >join/log</RouterLink
        >
      </nav>
    </div>
